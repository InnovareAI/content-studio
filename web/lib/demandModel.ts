...
> = {
  ...
  platformToneOfVoice: 'Keep one shared brand core, then adapt only for channels that have source evidence, existing audience, or an explicit strategy assumption in the Playbook.',
  channelStrategy: 'Start with source-backed channels. Add a channel only when the space has evidence there, the audience expects it, or the Playbook has saved it as a tested strategy assumption.',
