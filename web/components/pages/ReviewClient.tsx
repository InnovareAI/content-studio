...
const APPROVAL_WEBHOOK_URL = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/functions/v1/approval-webhook`
const SUPABASE_ANON_KEY = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY as string

// Platform and status chip helpers live in components/Chip, neutral
...
// Status-tab to underlying DB status value. Scheduled and Posted are derived
...
export default function ReviewClient({ initialView }: { initialView?: 'list' | 'board' | 'calendar' } = {}) {
